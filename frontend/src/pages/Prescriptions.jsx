          ...
          <div className="bg-white/5 backdrop-blur-2xl border border-white/10 p-8 rounded-[2.5rem] shadow-[0_8px_32px_rgba(0,0,0,0.5)] relative overflow-hidden transition-all duration-500 group hover:border-emerald-500/30 hover:shadow-[0_8px_32px_rgba(16,185,129,0.15)]">
            ...
            <div className="relative group/input mt-4">
              <textarea
                ...
                className="w-full h-40 bg-black/20 border border-white/10 group-hover/input:border-emerald-500/40 rounded-3xl p-5 text-white text-sm focus:outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 transition-all placeholder:text-gray-500 resize-none font-medium backdrop-blur-md shadow-inner"
